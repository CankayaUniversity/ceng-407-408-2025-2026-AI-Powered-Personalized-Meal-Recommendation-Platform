...
@Entity
@Table(name = "recommendation_menu_courses")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class RecommendationMenuCourse extends BaseEntity {
    ...
    private RecommendationMenu menu;
    ...
    private RecommendedRecipe recommendedRecipe;
}
