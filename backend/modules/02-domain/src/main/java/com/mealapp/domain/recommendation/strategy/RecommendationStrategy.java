...
public interface RecommendationStrategy {
    Recommendation recommend(User user, List<Inventory> currentInventory, DailyConsumptionService.DailyNutritionSummary dailySummary, String cravings, String aiModel, String apiKey, List<RecipeUsageHistory> history);
}
