...
include(":01-infrastructure:infrastructure-core")
include(":01-infrastructure:infrastructure-test")
project(":01-infrastructure:infrastructure-core").projectDir = file("backend/modules/01-infrastructure/infrastructure-core")
project(":01-infrastructure:infrastructure-test").projectDir = file("backend/modules/01-infrastructure/infrastructure-test")
