                ...
                <div className="overflow-y-auto flex-1">
                    {activeTab === 'converter' ? (
                        <div className="p-8 space-y-8">
                            ...
                            <IngredientSelector
                                label={t('unitConverter.ingredientLabel')}
                                query={searchQuery}
                                ...
                                renderExtraDetails={(ing) => (
                                    <div className="flex items-center justify-between px-4 py-2 bg-terracotta/5 border border-terracotta/20 rounded-xl">
                                        <span className="text-xs font-bold text-terracotta">{t('unitConverter.usingDensity', { name: ing.name })}</span>
                                    </div>
                                )}
